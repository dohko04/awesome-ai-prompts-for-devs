...
168 curated free samples across 7 categories. Each one is **complete and ready to use** — not a snippet, a full workflow.
...
|---|:---:|:---:|
| **Resources** | 95 curated samples | **266 production-grade** |
| **AI Agents** | 2 | **40** |
| **Vibe Coding** | 6 | **46** |
| **MCP Tools** | 1 | **11** |
| **RAG & Context** | 2 | **8** |

...
[**Get the Full AI Engineering Stack (177 resources) →**](https://ai-dev-toolkit-five.vercel.app)
...
78 curated free samples across 13 categories. Each one is **complete and ready to use** — not a snippet, a full workflow.
...
|---|:---:|:---:|
| **Resources** | 78 curated samples | **177 production-grade** |
| **AI Agents** | 2 | **40** |
| **Vibe Coding** | 6 | **46** |
| **MCP Tools** | 1 | **11** |
| **RAG & Context** | 2 | **8** |

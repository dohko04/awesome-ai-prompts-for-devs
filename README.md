...
[**Get the Full AI Engineering Stack (147 resources) →**](https://ai-dev-toolkit-five.vercel.app)
...
48 curated free samples across 11 categories. Each one is **complete and ready to use** — not a snippet, a full workflow.
...
|---|:---:|:---:|
| **Resources** | 48 curated samples | **147 production-grade** |
| **AI Agents** | 2 | **40** |
| **Vibe Coding** | 6 | **46** |
| **MCP Tools** | 1 | **11** |
| **RAG & Context** | 2 | **8** |
